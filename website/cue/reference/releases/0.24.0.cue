...
releases: "0.24.0": {
	...
	changelog: [
		...
		},
		{
			...
			scopes: ["vrl", "vrl: stdlib"]
			description: """
				VRL's `parse_grok` and `parse_groks` implementation was unified to avoid
				inconsistencies in pattern handling between the two.
				"""
			pr_numbers: [13635]
		},
		{
	...
	commits: [
		...
		{sha: "800b7cf39[ab4ba987bc251e2fa6effd94864e94b", date: "2022-08-24 04:21:11 UTC", description: "announce deprecation of renamed components in 0.24.0", pr_number:                             14050, scopes: ["external docs"], type:                                              "chore", breaking_change:       false, author: "Toby Lawrence", files_count:          1, insertions_count:    29, deletions_count:   0},
